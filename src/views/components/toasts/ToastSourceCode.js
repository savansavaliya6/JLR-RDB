    ...
    <Row>
      <Col md='6' sm='12'>
        <div className='p-3 bg-primary my-2 rounded'>
          <Toast>
            <ToastHeader close={close}>jlr</ToastHeader>
            <ToastBody>
...
const ToastHeaderIcons = () => {
  return (
    <Row>
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='primary'>jlr</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='success'>jlr</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='info'>jlr</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='danger'>jlr</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='warning'>jlr</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='dark'>jlr</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
        <ToastHeader close={close} icon={logo}>jlr</ToastHeader>
