...
const AccesoryAddModal = ({ popup, setPopup, handleChangeFromChild }) => {
      ...
      {addAccessoryListPopup && (
        ...
        >
          ...
          >
            ...
            >
              <img
                ...
                width={"30"}
                onClick={() => {
                  setSelectedValue({ accessory_list: [] });
          ...
          <ModalBody className="mx-50 pb-2">
            ...
            >
              <Row>
                {JSON.stringify(selectedValue.accessory_list)}
...
export default AccesoryAddModal;
